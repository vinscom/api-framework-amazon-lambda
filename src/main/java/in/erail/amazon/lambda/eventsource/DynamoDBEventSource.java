 ...
 * @author vinay
 */
public class DynamoDBEventSource implements EventSource {

  public static final String URL = "/aws/dynamodb";
  public static final String ENV_NAME = "api.framework.lambda.dynamodb.url";
  private final String url = Util.getEnvironmentValue(ENV_NAME, URL);

  @Override
  public EventSourceName getEventSourceName() {
    return EventSourceName.DYNAMODB;
  }
